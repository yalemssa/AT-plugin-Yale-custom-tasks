...
package edu.yale.plugins.tasks.dbdialog;
...
public class RemoteDBConnectDialog extends JDialog {
    ...
    // used to specify the the AT SessionFactory is being used
    boolean useSessionFactory = false;
    ...
    public RemoteDBConnectDialog(Frame owner, boolean useSessionFactory) {
        ...
        this.useSessionFactory = useSessionFactory;

        this.sessionFactory = SessionFactory.getSessionFactory();
        initComponents();

        // hide certain gui components
        setGuiReadOnly();
    }
    ...
    /**
     * Method to load the resources and users
     */
    public void loadResourcesAndUsers() {
    ...
    /**
     * Method to return the currently selected resource record
     *
     * @return
     * @throws Exception
     */
    ...
    /**
     * Method to get a notes etc type by connical name
     *
     * @param name
     * @return
     */
    public NotesEtcTypes lookupNoteEtcTypeByName(String name) {
        ...
        return notesEtcTypesList.get(name);
    }
    ...
    private void loadNotesEtcTypesByNames() {
        try {
            ...
            Criteria criteria = session.createCriteria(NotesEtcTypes.class);
