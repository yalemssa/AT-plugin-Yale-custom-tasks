...
public class BoxLookupReturnScreen extends ATBasicDialog {
	...
	private void initComponents() {
        ...
        panel3 = new JPanel();
        label7 = new JLabel();
        containerFilterTextField = new JTextField();
        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                //======== panel2 ========
                {
                    ...
                    panel2.add(boxField, cc.xy(19, 1, CellConstraints.FILL, CellConstraints.DEFAULT));
                ...
                //======== panel3 ========
                {
                    ...
                    panel3.add(containerFilterTextField, cc.xy(3, 1));
                }
                contentPanel.add(panel3, cc.xy(1, 3));
                ...
                contentPanel.add(scrollPane1, cc.xy(1, 5, CellConstraints.FILL, CellConstraints.FILL));
                ...
                contentPanel.add(panel1, cc.xy(1, 7));
            }
    ...
    private JTextField containerFilterTextField;
